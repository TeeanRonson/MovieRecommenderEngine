...
/** Test file for MovieRatingsList.
...
public class MovieRatingsListTest {
    ...
    public void testIterator() {
        ...
        Iterator<MovieRatingNode> it = movieRatingsList.iterator();
    ...
    public void testMedianRating() {
        MovieRatingsList list = initalizeListWithValues(MOVIES, RATINGS);
    ...
    public void testReverse() {
        ...
        Iterator<MovieRatingNode> it = list.iterator();
        Assert.assertEquals(it.hasNext(), true);
        MovieRatingNode head = it.next();

        MovieRatingsList reversed = list.reverse(head);
        Assert.assertEquals("The number of nodes in a reversed list is not the same as in the original list", numNodes(reversed), 7);
        Iterator<MovieRatingNode> itRev = reversed.iterator();
     ...
     * @return
     */
    public static MovieRatingsList initalizeListWithValues(int[] movieIds, double[] ratings) {
